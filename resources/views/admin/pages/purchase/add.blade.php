...
@section('title','Admin | Add Purchase Information')
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-default py-2 d-flex justify-content-between align-items-center">
                <h4 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-user-circle"></i>  Add Purchase Information
                </h4>

            </div>
            <form id="ajaxForm" class="" action="{{route('purchase.store')}}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="from" type="text" class="form-control" name="book" value=""  placeholder="">
